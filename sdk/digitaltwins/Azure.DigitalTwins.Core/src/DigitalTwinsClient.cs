...
namespace Azure.DigitalTwins.Core
{
    ...
    public class DigitalTwinsClient
    {
        ...
        /// <returns>The pageable list <see cref="AsyncPageable{T}"/> of query results.</returns>
        /// <typeparam name="T">The type to deserialize the result to.</typeparam>
        public virtual AsyncPageable<T> QueryAsync<T>(DigitalTwinsQuery<T> adtQueryBuilder, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(DigitalTwinsClient)}.{nameof(Query)}");
            scope.Start();
        ...
        /// <typeparam name="T">The type to deserialize the result to.</typeparam>
        public virtual Pageable<T> Query<T>(DigitalTwinsQuery<T> adtQueryBuilder, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(DigitalTwinsClient)}.{nameof(Query)}");
            scope.Start();
