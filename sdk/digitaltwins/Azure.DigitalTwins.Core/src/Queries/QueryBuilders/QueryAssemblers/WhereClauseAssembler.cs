...
namespace Azure.DigitalTwins.Core.QueryBuilder
{
    ...
    internal class WhereClauseAssembler
    {
        ...
        /// <returns>The <see cref="WhereClauseAssembler"/> object itself.</returns>
        public WhereClauseAssembler Compare<T>(string field, QueryComparisonOperator comparisonOperator, T value)
        {
        ...
        /// <returns>The <see cref="WhereClauseAssembler"/> object itself.</returns>
        public WhereClauseAssembler Contains(string value, string[] searched)
        {
        ...
        /// <param name="searched">Field of possible options to check for the <c>value</c> parameter.</param>
        /// <returns>The <see cref="WhereClauseAssembler"/> object itself.</returns>
        public WhereClauseAssembler NotContains(string value, string[] searched)
        {
            Argument.AssertNotNullOrWhiteSpace(value, nameof(value));
        ...
        /// <returns>The <see cref="WhereClauseAssembler"/> object itself.</returns>
        public WhereClauseAssembler Custom(string condition)
        {
        ...
        /// <returns>The <see cref="WhereClauseAssembler"/> object itself.</returns>
        public WhereClauseAssembler IsDefined(string property)
        {
        ...
        /// <returns>The <see cref="WhereClauseAssembler"/> object itself.</returns>
        public WhereClauseAssembler IsNull(string expression)
        {
        ...
        /// <returns>The <see cref="WhereClauseAssembler"/> object itself.</returns>
        public WhereClauseAssembler StartsWith(string stringToCheck, string beginningString)
        {
        ...
        /// <returns>The <see cref="WhereClauseAssembler"/> object itself.</returns>
        public WhereClauseAssembler EndsWith(string stringToCheck, string endingString)
        {
            Argument.AssertNotNullOrWhiteSpace(stringToCheck, nameof(stringToCheck));
        ...
        /// <returns>The <see cref="WhereClauseAssembler"/> object itself.</returns>
        public WhereClauseAssembler IsOfModel(string model, bool exact = false)
        {
        ...
        /// <returns>The <see cref="WhereClauseAssembler"/> object itself.</returns>
        public WhereClauseAssembler IsOfType(string expression, DigitalTwinsDataType type)
        {
            Argument.AssertNotNullOrWhiteSpace(expression, nameof(expression));
        ...
        /// <returns>The <see cref="WhereClauseAssembler"/> object itself.</returns>
        public WhereClauseAssembler Precedence(Func<WhereClauseAssembler, WhereClauseAssembler> nested)
        {
            var nestedLogic = new WhereClauseAssembler();
        ...
        /// <param name="nested">WhereQuery methods to perform within a set of parenthesis.</param>
        /// <returns>The <see cref="WhereClauseAssembler"/> object itself.</returns>
        public WhereClauseAssembler And(Func<WhereClauseAssembler, WhereClauseAssembler> nested)
        {
            var nestedLogic = new WhereClauseAssembler();
            nested.Invoke(nestedLogic);
        ...
        /// </summary>
        /// <returns>The <see cref="WhereClauseAssembler"/> object itself.</returns>
        public WhereClauseAssembler And()
        {
        ...
        /// <param name="nested">WhereQuery methods to perform within a set of parenthesis.</param>
        /// <returns>The <see cref="WhereClauseAssembler"/> object itself.</returns>
        public WhereClauseAssembler Or(Func<WhereClauseAssembler, WhereClauseAssembler> nested)
        {
            var nestedLogic = new WhereClauseAssembler();
            nested.Invoke(nestedLogic);
        ...
        /// </summary>
        /// <returns>The <see cref="WhereClauseAssembler"/> object itself.</returns>
        public WhereClauseAssembler Or()
        {
